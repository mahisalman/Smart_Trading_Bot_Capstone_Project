...
# ---------------------------
VOLUME = 0.01
SL_PRICE_DIFF = 10.00    # USD distance for SL
TP_PRICE_DIFF = 20.00    # USD distance for TP
TRADE_DEVIATION = 30
TRADE_MAGIC = 2025
...
# ==========================================================
# ✅ Step 2: Find Tradeable XAUUSD Symbol
# ==========================================================
def find_tradeable_gold_symbol():
    print("\n🔎 Searching for tradeable Gold (XAUUSD) symbols...")
